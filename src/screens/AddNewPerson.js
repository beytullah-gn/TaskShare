...
import { SafeAreaView, Text, StyleSheet, View, TextInput, Button, Alert, ScrollView } from "react-native";
...
const AddNewPersonScreen = () => {
  ...
  const handleAddPerson = async () => {
    ...
    try {
      ...
      // Kullanıcı oluşturulduktan sonra person ID'si oluşturma
      const personRef = push(ref(db, 'Persons'));
      const personId = personRef.key;

      // Firebase Realtime Database'e yeni kullanıcı ve person bilgilerini ekle
      ...
      // Butonu 5 saniye devre dışı bırak
